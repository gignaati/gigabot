    ...
    case 'anthropic': {
      ...
      if (!apiKey) {
        throw new Error(
          ...
          'Then run: npx gigabot set-agent-secret ANTHROPIC_API_KEY'
        );
      }
    ...
    case 'openai': {
      ...
      if (!apiKey) {
        throw new Error(
          ...
          'Then run: npx gigabot set-agent-secret OPENAI_API_KEY'
        );
      }
    ...
    case 'google': {
      ...
      if (!apiKey) {
        throw new Error(
          ...
          'Then run: npx gigabot set-agent-secret GOOGLE_API_KEY'
        );
      }
    ...
    case 'pragatigpt': {
      ...
      if (!apiKey) {
        throw new Error(
          ...
          'Then run: npx gigabot set-agent-secret PRAGATIGPT_API_KEY'
        );
      }
